...
class Region:
    ...
    def activate_missile_defenses(self, attacker_player_id, missile_type: str, local_missile_defense: bool):
        '''
        Exaust all options to defend from incoming missile strike.

        :param missile_type: the type of the incoming missile
        :param local_missile_defense: True if player has Local Missile Defense researched.
        :param war_name: name of war this is for
        '''
        import core
        from app.improvement import Improvement
