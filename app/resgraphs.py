...
def update_research_graphic(research_type, completed_research_dictionary, player_colors_list, full_game_id):
    '''
    ...
    match research_type:
        case 'Agenda':
            filename = '0-Agenda'
            research_dict = core.agenda_data_dict
        case 'Energy':
            filename = '1-Energy'
...
def update_all(full_game_id):
    ...
    keys = set(core.agenda_data_dict.keys()).union(core.research_data_dict.keys())
    ...
    for research_type in research_types:
        update_research_graphic(research_type, completed_research_dictionary, player_colors_list, full_game_id)

def update_one(full_game_id, research_type):
