...
It mocks the Games class to prevent writes to disk and includes basic load tests to make sure everything is initialized properly.

Note: The load tests for the dataclasses are very basic and only test data retrieval/loading. 
